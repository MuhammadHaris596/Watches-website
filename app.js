    var watches = {
      ...
      var productBrand = document.getElementById('product-select')
     ...
     function selected(){
      ...
      for ( var product in watches[selectedBrand]){
        productBrand.innerHTML += 
        `<option  value="${watches[selectedBrand][product].name}">${watches[selectedBrand][product].name}</option>`
      }
     }
     ...
     function btnSubmit(){
      ...
      for ( var products in watches[selectedBrand]){
        ...
        if ( watches[selectedBrand][products].name === productBrand){
          // window.location.href = 'product.html'
          newProduct.innerHTML = `
                <div class=" text-center d-flex bottom card border" style="width: 18rem;">
                    <img src="${watches[selectedBrand][products].img}" class="card-img-top" alt="card-image">
                    <div class="card-body">
                      <h5 class="card-title text-center">${watches[selectedBrand][products].name}</h5>
                      <p class="card-text text-center">The Oyster Perpetual Explorer in Oystersteel features a distinctive black dial with characteristic 3, 6, and 9 numerals with a Chromalight display. </p>
                      <p class="text-center p-tg">${watches[selectedBrand][products].price}</p>
                      <div class="text-center">
                      <a href="#" class="btn btn-primary my-btn ">Buy Now</a>
                    </div>
                    </div>
                </div>`
